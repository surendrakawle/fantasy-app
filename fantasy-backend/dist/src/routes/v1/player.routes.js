 ...
 */
router.get("/", auth_middleware_1.authMiddleware, player_controller_1.listPlayers);
/* -------------------------------------------------------------------------- */
/*                               GET PLAYER                                   */
/* -------------------------------------------------------------------------- */
/**
 ...
 *         description: Internal server error
 */
router.get("/:id", auth_middleware_1.authMiddleware, player_controller_1.getPlayer);
/* -------------------------------------------------------------------------- */
/*                               CREATE PLAYER                                */
/* -------------------------------------------------------------------------- */
/**
 ...
 *         description: Internal server error
 */
router.post("/", auth_middleware_1.authMiddleware, admin_middleware_1.adminOnly, player_controller_1.createPlayer);
/* -------------------------------------------------------------------------- */
/*                               UPDATE PLAYER                                */
/* -------------------------------------------------------------------------- */
/**
 ...
 *         description: Internal server error
 */
router.put("/:id", auth_middleware_1.authMiddleware, admin_middleware_1.adminOnly, player_controller_1.updatePlayer);
/* -------------------------------------------------------------------------- */
/*                              DEACTIVATE PLAYER                              */
/* -------------------------------------------------------------------------- */
/**
 ...
 *         description: Internal server error
 */
router.delete("/:id", auth_middleware_1.authMiddleware, admin_middleware_1.adminOnly, player_controller_1.deactivatePlayer);
