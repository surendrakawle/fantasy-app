...
const userPrediction_controller_1 = require("../../controllers/userPrediction.controller");
 ...
 */
router.get("/:contestId", auth_middleware_1.authMiddleware, userPrediction_controller_1.getMyPredictionsByContest);
